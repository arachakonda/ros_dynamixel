...
groupBulkWrite = groupBulkWrite(portHandler, PROTOCOL_VERSION)
...
def bulkRead(groupBulkRead, id, param_addr, param_len):
...
def main():
    ...
    enable_torque(portHandler, DXL_ID)
    add_param(groupBulkRead, DXL_ID, ADDR_PRESENT_POS, LEN_PRESENT_POS)
    add_param(groupBulkRead, DXL_ID, ADDR_PRESENT_CURRENT, LEN_PRESENT_CURRENT)
    rate = rospy.Rate(10)

    while not rospy.is_shutdown:
        print(bulkRead(groupBulkRead, DXL_ID, ADDR_PRESENT_POS, LEN_PRESENT_POS))
        rate.sleep()
